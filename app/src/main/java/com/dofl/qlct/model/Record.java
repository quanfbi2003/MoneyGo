...
public class Record {
    ...
    public double getN1_total() {
        return n1_total;
    }

    public void setN1_total(double n1_total) {
        this.n1_total = n1_total;
    }

    public double getN2_total() {
        return n2_total;
    }

    public void setN2_total(double n2_total) {
        this.n2_total = n2_total;
    }

    public double getN3_total() {
        return n3_total;
    }

    public void setN3_total(double n3_total) {
        this.n3_total = n3_total;
    }

    public double getN4_total() {
        return n4_total;
    }

    public void setN4_total(double n4_total) {
